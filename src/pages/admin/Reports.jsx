    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white dark:bg-secondary-800 rounded-lg shadow-sm p-6">
          ...
          <p className="text-2xl font-semibold text-secondary-900 dark:text-white mt-2">₹2,78,999</p>
        ...
        <div className="bg-white dark:bg-secondary-800 rounded-lg shadow-sm p-6">
          ...
          <p className="text-2xl font-semibold text-secondary-900 dark:text-white mt-2">₹1,789</p>
